...
exports.create = function (req, res) {
    ...
    form.parse(req, function (err, fields, files) {
        ...
        if (!fields.public) fields.public = false;
        if (!fields.nsfw) fields.nsfw = false;
        if (!fields.visible) fields.visible = true;

        if (fields.public == 'on') fields.public = true;
        if (fields.nsfw == 'on') fields.nsfw = true;
        ...
        fields.photo = this.uploadImage(files.image_work)
        ...
        global.db.Sequelize.Promise.all(promises).then(function (results) {
            ...
            promises = [
                global.db.Category.findById(fields.category),
                global.db.Work.create(fields)
            ];
