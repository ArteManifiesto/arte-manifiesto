...
APP.AdminGeneralScreen.prototype.listeners = function () {
  ...
  this.start.datepicker(options).on('changeDate', this.startDateChange.bind(this));
  this.end.datepicker(options).on('changeDate', this.endDateChange.bind(this));
  this.searchBtn.click(this.searchHander.bind(this));
};

APP.AdminGeneralScreen.prototype.startDateChange = function () {
  this.startValue = e.date;
};

APP.AdminGeneralScreen.prototype.endDateChange = function () {
  this.endValue = e.date;
};
