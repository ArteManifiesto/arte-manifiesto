...
APP.AdminUsersScreen.prototype.dropdownChange = function (event) {
   ...
   switch(text) {
     case 'username': this.term = 'username';break;
     case 'email': this.term = 'email';break;
     case 'ciudad': this.term = 'city';break;
     case 'pais': this.term = 'country';break;
     case 'artista': this.term = 'isArtist';break;
     case 'verificado': this.term = 'verified';break;
     case 'completo': this.term = 'filled';break;
   }
};
