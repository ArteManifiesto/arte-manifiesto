...
APP.EditorScreen.prototype.setupUI = function() {
  ...
  var rect = new fabric.Rect({
      width: config.width, height: config.offsetY, left: 0, top: 0, fill: 'red',
      opacity: 0.5
  });
  var rect2 = new fabric.Rect({
      width: config.width, height: config.offsetY, left: 0, top: config.height + config.offsetY, fill: 'red',
      opacity: 0.5
  });
