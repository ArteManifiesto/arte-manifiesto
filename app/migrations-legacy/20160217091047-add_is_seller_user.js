...
module.exports = {
  up: function(queryInterface, Sequelize) {
    ...
    queryInterface.addColumn('Users', 'direction', {
      type: Sequelize.STRING
    });
    queryInterface.addColumn('Users', 'phone', {
      type: Sequelize.STRING
    });
    queryInterface.addColumn('Users', 'document', {
      type: Sequelize.STRING
    });
    queryInterface.addColumn('Users', 'documentValue', {
      type: Sequelize.STRING
    });
    queryInterface.addColumn('Users', 'businessName', {
      type: Sequelize.STRING
    });
  },
