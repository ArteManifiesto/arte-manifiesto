...
function Slider(e,t){function n(){c.on("swipeleft",function(){clearInterval(v),v=setInterval(r,5e3),r()}),c.on("swiperight",function(){clearInterval(v),v=setInterval(r,5e3),a()});for(var e=0;e<i.length;e++)i[e].setAttribute("index",e);for(var e=0;e<i.length;e++)i[e].addEventListener("click",function(){clearInterval(v),v=setInterval(r,5e3),l(parseInt(this.getAttribute("index")))})}function r(){o!=s.length-1&&l(o+1)}function a(){0!=o&&l(o-1)}function l(e){for(var t=0;t<s.length;t++){var n=s[t].style;n.webkitTransform="translate("+-100*e+"%,0)translateZ(0)",n.msTransform=n.MozTransform=n.OTransform="translateX("+-100*e+"%)"}i[o].classList.remove("active"),o=e,i[o].classList.add("active")}var s=e.querySelectorAll("."+t.slideClass),i=e.querySelectorAll("."+t.sliderNavItemClass),o=0,c=new Hammer(e),v=setInterval(r,1e4);n()}
