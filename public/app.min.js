...
var APP=APP||{},normal=function(){for(var t="ÃÀÁÄÂÈÉËÊÌÍÏÎÒÓÖÔÙÚÜÛãàáäâèéëêìíïîòóöôùúüûÑñÇç",e="AAAAAEEEEIIIIOOOOUUUUaaaaaeeeeiiiioooouuuunncc",n={},i=0,a=t.length;a>i;i++)n[t.charAt(i)]=e.charAt(i);return function(t){for(var e=[],i=0,a=t.length;a>i;i++){var o=t.charAt(i);n.hasOwnProperty(t.charAt(i))?e.push(n[o]):e.push(o)}return e.join("")}}();APP.BuyScreen=function(){this.productConfig=JSON.parse(product.config),APP.BaseScreen.call(this,"buy"),this.totalShipping,this.currentIgv,this.totalPrice},APP.BuyScreen.constructor=APP.BuyScreen,APP.BuyScreen.prototype=Object.create(APP.BaseScreen.prototype),APP.BuyScreen.prototype.setupUI=function(){this.payBtn=$(".btn-pay"),this.form=$("form[name=buy-form]")},APP.BuyScreen.prototype.listeners=function(){APP.BaseScreen.prototype.listeners.call(this),$("select[name=city]").change(this.cityChangeHandler.bind(this)),$("select[name=city]").change(),this.form.submit(this.submitHandler.bind(this)),$("input[name=direction]").geocomplete()},APP.BuyScreen.prototype.submitHandler=function(t){var e=$("input[name=firstname]").val(),n=$("input[name=lastname]").val(),i=$("input[name=direction]").val(),a=$("input[name=departament]").val(),o=$("select[name=city]").val(),r=$("input[name=province]").val(),s=$("input[name=zipcode]").val(),p=$("select[name=country]").val(),c=$("input[name=phone]").val(),l=$("input[name=email]").val(),u=[];if(Validations.notBlank(e)&&u.push("Ingrese un nombre"),Validations.notBlank(n)&&u.push("Ingrese tus apellidos"),Validations.notBlank(i)&&u.push("Ingrese una dirección"),Validations.notBlank(o)&&u.push("Ingrese tú ciudad"),Validations.notBlank(r)&&u.push("Ingrese tú provincia"),Validations.notBlank(s)&&u.push("Ingrese el código postal"),Validations.notBlank(c)&&u.push("Ingrese tú telefono"),Validations.notBlank(l)&&u.push("Ingrese tú correo"),u.length>0)return this.showFlash("error",u);var h={firstname:e,lastname:n,direction:i,departament:a,city:o,province:r,zipcode:s,country:p,phone:c,email:l};$('<input type="hidden" name="data" value='+JSON.stringify(h)+">").appendTo(this.form),$('<input type="hidden" name="shipping" value='+this.totalShipping+">").appendTo(this.form),$('<input type="hidden" name="price" value='+this.totalPrice+">").appendTo(this.form),h.shipping=this.totalShipping,h.price=this.price,Cookies.set("order_data",JSON.stringify(h),{maxAge:36e5,domain:"."+document.domain})},APP.BuyScreen.prototype.cityChangeHandler=function(){var t=normal($("select[name=city]").val()),e="/user/"+product.User.username+"/product/shipping";"Pucallpa"===t&&(t="PUCALLPA (CALLERIA)"),"Chincha"===t&&(t="CHINCHA ALTA");var n={nom_destino:t.toUpperCase(),peso:this.productConfig.pkgWeight,servicio:"Atencion en Oficina",options2:"Kilos",largo:this.productConfig.pkgLarge,ancho:this.productConfig.pkgWidth,alto:this.productConfig.pkgHeight,cantidad:1,m_largo:"cms",m_ancho:"cms",m_alto:"cms"};this.requestHandler(e,{config:JSON.stringify(n)},this.shippingHandler)},APP.BuyScreen.prototype.shippingHandler=function(t){var e=t.data.data;this.totalShipping=Number(e.monto_total)+.06*Number(e.monto_total),this.totalPrice=Number(product.finalPrice)+this.totalShipping,$(".subtotal").text(product.finalPrice),$(".baseprice").text(this.totalShipping),$(".totallity").text(this.totalPrice)};
