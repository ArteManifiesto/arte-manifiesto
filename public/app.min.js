...
var APP=APP||{};APP.BaseScreen=function(e){this.id=e,this.setupUI(),this.listeners()},APP.BaseScreen.prototype=Object.create(Object.prototype),APP.BaseScreen.constructor=APP.BaseScreen,APP.BaseScreen.prototype.setupUI=function(){},APP.BaseScreen.prototype.listeners=function(){},APP.BaseScreen.prototype.requestHandler=function(e,t,o,r,s){!s&&Utils.checkAuthentication(),$.post(e,t).then(this.requestComplete.bind(this,o,r))},APP.BaseScreen.prototype.requestComplete=function(e,t,o){if(console.log("response ===>",o),200!==o.status){var r=o.data.errors||["Parece que algo fallo, por favor refresca la página"];return t&&t.bind(this)(),this.showFlash("error",r)}e.bind(this)(o)},APP.BaseScreen.prototype.showFlash=function(e,t){var o=$("."+e);$(".flash-message").css("visibility","hidden");var r=o.find(".content-text");if(r.empty(),"error"===e)for(var s=0;s<t.length;s++)r.append($("<p>").text("✘ "+t[s]));else r.text(t);o.css("visibility","visible"),o.removeClass("fadeIn");var n=setTimeout(function(){clearTimeout(n),o.addClass("fadeIn")},100)},APP.BaseScreen.prototype.getTemplate=function(e){var t="";return-1!==["followings","followers"].indexOf(e)&&(t="user"),"portfolio"===e&&(t="work"),"products"===e&&(t="product"),"collections"===e&&(t="collection"),t},APP.BaseScreen.prototype.clean=function(){};
var APP=APP||{};APP.AdCreator=function(t,e){APP.BaseElement.call(this,t,"ad-creator",e)},APP.AdCreator.prototype=Object.create(APP.BaseElement.prototype),APP.AdCreator.constructor=APP.AdCreator,APP.AdCreator.prototype.listeners=function(){},APP.AdCreator.prototype.clickViewHandler=function(){},APP.AdCreator.prototype.getData=function(){var t=this.view.find("input[name=photo]").val(),e=this.view.find("input[name=description]").val(),n=this.view.find("input[name=link]").val(),o=[];return Validations.notBlank(t)&&o.push(1),Validations.notBlank(e)&&o.push(1),Validations.notBlank(n)&&o.push(1),o.length>0?null:{photo:t,description:e,link:n,AdTypeId:this.data.id}};
...
var APP=APP||{};APP.AdminAdCreator=function(){APP.BaseScreen.call(this,"adminAdCreator")},APP.AdminAdCreator.constructor=APP.AdminAdCreator,APP.AdminAdCreator.prototype=Object.create(APP.BaseScreen.prototype),APP.AdminAdCreator.prototype.setupUI=function(){this.nameCampaign=$("input[name=nameCampaign]"),this.startDate=$("input[name=startDate]"),this.startDate.datepicker(),this.endDate=$("input[name=endDate]"),this.endDate.datepicker(),this.adPackType=$("input[name=adPackType]"),this.ads=[]},APP.AdminAdCreator.prototype.listeners=function(){APP.BaseScreen.prototype.listeners.call(this),$("form").submit(this.formSubmit.bind(this)),this.adPackType.change(this.adPackTypeChange.bind(this)),$('input[name=adPackType][data-index="0"]').attr("checked",!0).change()},APP.AdminAdCreator.prototype.formSubmit=function(t){t.preventDefault();var a=[],e=this.nameCampaign.val(),n=this.startDate.val(),r=this.endDate.val(),i=this.adPackType.val(),s=[];if(this.ads.map(function(t){var e=t.getData();e?s.push(e):a.push("Llene los anuncios correctamente")}),a.length>0)return this.showFlash("error",[a[0]]);var d={name:e,startDate:n,endDate:r,adPackType:i,ads:JSON.stringify(s)},o=DataApp.baseUrl+"report/brands/"+brand.id+"/ad-creator";this.requestHandler(o,d,this.adCreatorComplete)},APP.AdminAdCreator.prototype.adCreatorComplete=function(t){console.log(t)},APP.AdminAdCreator.prototype.adPackTypeChange=function(t){var a=$(t.target),e=a.data("index"),n=adPackTypes[e];$(".images-links").empty(),this.ads=[],n.Types.map(function(t){var a=new APP.AdCreator(t);this.ads.push(a),$(".images-links").append(a.view)}.bind(this))};
