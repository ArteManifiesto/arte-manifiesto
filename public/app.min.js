...
var APP=APP||{};APP.BaseNavigation=function(){this.currentPage=0,this.totalPages=null,this.currentPageData,this.listeners(),this.needChangeUrl=!1,this.ajax=null},APP.BaseNavigation.constructor=APP.BaseNavigation,APP.BaseNavigation.prototype=Object.create(EventDispatcher.prototype),APP.BaseNavigation.prototype.start=function(){},APP.BaseNavigation.prototype.listeners=function(){},APP.BaseNavigation.prototype.suspend=function(){},APP.BaseNavigation.prototype.restart=function(){},APP.BaseNavigation.prototype.gotoPage=function(t,a){var e=t||this.currentPage+1;if(!a){if(this.currentPage===e)return;0===this.currentPage&&(this.currentPage=1)}this.totalPages&&e>this.totalPages||(this.dispatchEvent({type:Events.LOAD_START}),this.newPageUrl(e),this.ajax=Utils.getData({url:DataApp.currentUrl}).done(this.afterGetData.bind(this)))},APP.BaseNavigation.prototype.afterGetData=function(t){this.currentPage=t.pagination.page,this.totalPages=t.pagination.pages,this.currentPageData=t,this.dispatchEvent({type:Events.LOAD_END,data:t})},APP.BaseNavigation.prototype.newPageUrl=function(t){DataApp.currentUrl=DataApp.currentUrl.replace(/\/$/g,""),-1===DataApp.currentUrl.indexOf("/page-")&&(DataApp.currentUrl+="/page-"+this.currentPage),DataApp.currentUrl=DataApp.currentUrl.replace("page-"+this.currentPage,"page-"+t),Utils.changeUrl("",DataApp.currentUrl)},APP.BaseNavigation.prototype.reset=function(){this.ajax&&this.ajax.abort(),this.currentPageData=null,this.gotoPage(1,!0),Utils.changeUrl("",DataApp.currentUrl)};
