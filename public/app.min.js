...
var APP=APP||{};APP.AdCreator=function(t,e){APP.BaseElement.call(this,t,"ad-creator",e)},APP.AdCreator.prototype=Object.create(APP.BaseElement.prototype),APP.AdCreator.constructor=APP.AdCreator,APP.AdCreator.prototype.listeners=function(){},APP.AdCreator.prototype.clickViewHandler=function(){},APP.AdCreator.prototype.getData=function(){return{photo:this.view.find("input[name=photo]").val(),description:this.view.find("input[name=description]").val(),link:this.view.find("input[name=link]").val()}};
...
var APP=APP||{};APP.AdminAdCreator=function(){APP.BaseScreen.call(this,"adminAdCreator")},APP.AdminAdCreator.constructor=APP.AdminAdCreator,APP.AdminAdCreator.prototype=Object.create(APP.BaseScreen.prototype),APP.AdminAdCreator.prototype.setupUI=function(){this.sendBtn=$('button[data-id="send"]'),this.ads=[]},APP.AdminAdCreator.prototype.listeners=function(){APP.BaseScreen.prototype.listeners.call(this),this.sendBtn.click(this.sendClickHandler.bind(this)),$("input[name=adPackType]").change(this.adPackTypeChange.bind(this)),$('input[name=adPackType][data-index="0"]').attr("checked",!0).change()},APP.AdminAdCreator.prototype.sendClickHandler=function(e){e.preventDefault(),this.ads.map(function(e){console.log(e.getData())})},APP.AdminAdCreator.prototype.adPackTypeChange=function(e){var t=$(e.target),a=t.data("index"),n=adPackTypes[a];$(".images-links").empty(),this.ads=[],n.Types.map(function(e){var t=new APP.AdCreator(e);this.ads.push(t),$(".images-links").append(t.view)}.bind(this))};
