...
var APP=APP||{};APP.AuthScreen=function(e){this.meta=e,APP.BaseScreen.call(this,"auth"),void 0},APP.AuthScreen.constructor=APP.AuthScreen,APP.AuthScreen.prototype=Object.create(APP.BaseScreen.prototype),APP.AuthScreen.prototype.listeners=function(){APP.BaseScreen.prototype.listeners.call(this),$(".fb").click(this.fbHandler.bind(this)),$(".auth-form").submit(this.formHandler.bind(this))},APP.AuthScreen.prototype.fbHandler=function(){$(".fb").hide(),$(".fb-loading").show()},APP.AuthScreen.prototype.formHandler=function(e){e.preventDefault(),$(".submit").hide(),$(".submit-loading").show();var t="/auth/"+this.meta,r=$(".auth-form").serialize();this.requestHandler(t,r,this.requestAuthComplete,this.requestAuthError,!0)},APP.AuthScreen.prototype.requestAuthError=function(e){"signup"===this.meta&&grecaptcha.reset(),$(".submit").show(),$(".submit-loading").hide()},APP.AuthScreen.prototype.requestAuthComplete=function(e){if($(".submit").show(),$(".submit-loading").hide(),"reset"===this.meta){this.showFlash("succes","Contraseña cambiada");var t=setTimeout(function(){return clearTimeout(t),location.href="/auth/login"},1e3)}else{if("forgot"!==this.meta)return location.href=e.data.returnTo;this.showFlash("succes","Se envio el correo")}};
