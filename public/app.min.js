...
var APP=APP||{};APP.AddProductScreen=function(){APP.BaseScreen.call(this,"addProduct"),this.product=null},APP.AddProductScreen.constructor=APP.AddProductScreen,APP.AddProductScreen.prototype=Object.create(APP.BaseScreen.prototype),APP.AddProductScreen.prototype.setupUI=function(){this.workForm=$(".work-form"),this.uploader=$(".uploader-work"),this.name=$("input[name=name]"),this.shortDescription=$("input[name=short]"),this.weight=$("input[name=weight]"),this.price=$("input[name=price]"),this.profit=$("input[name=profit]"),this.finalPrice=$("input[name=finalPrice]"),this.category=$("select[name=category]"),this.description=$("textarea[name=description]"),this.information=$("textarea[name=information]"),this.tags=$("input[name=tags]"),this.tags.tagsInput({height:"50px",width:"100%",defaultText:"+Etiqueta"}),this.send=$(".send"),this.sendLoading=$(".send-loading"),this.uploaderImage=new APP.UploaderImage(this.uploader,this.imgComplete)},APP.AddProductScreen.prototype.listeners=function(){APP.BaseScreen.prototype.listeners.call(this),this.workForm.submit(this.workFormSubmitHandler.bind(this)),this.profit.on("input change paste",this.priceHandler.bind(this)),this.category.change(this.categoryHandler.bind(this))},APP.AddProductScreen.prototype.workFormSubmitHandler=function(t){t.preventDefault();var e=[],i=this;if(this.uploaderImage.photo||e.push("Ingrese una foto"),Validations.notBlank(this.name.val())&&e.push("Ingrese un nombre"),Validations.notBlank(this.shortDescription.val())&&e.push("Ingrese una descripcion corta"),Validations.notBlank(this.weight.val())&&e.push("Ingrese un peso"),Validations.notBlank(this.price.val())&&e.push("Ingrese un precio"),Validations.notBlank(this.profit.val())&&e.push("Ingrese una ganancia de artista"),Validations.notBlank(this.finalPrice.val())&&e.push("Ingrese el precio final"),Validations.notBlank(this.category.val())&&e.push("Ingrese una categoria"),Validations.notBlank(this.description.val())&&e.push("Ingrese una descripcion"),Validations.notBlank(this.information.val())&&e.push("Ingrese informacion del producto"),this.tags.val().split(",")[0].length<1&&e.push("Ingrese etiquetas"),e.length>0)return this.showFlash("error",e);this.sendLoading.show(),this.send.hide();var r=this.information.val().split("\n"),n={weight:this.weight.val(),description:this.description.val(),info:JSON.stringify(r)},o={name:this.name.val(),description:this.shortDescription.val(),price:(1.2*parseInt(this.finalPrice.val())).toString(),finalPrice:this.finalPrice.val(),photo:i.uploaderImage.photo,printPhoto:i.uploaderImage.photo,config:JSON.stringify(n),UserId:work.UserId,WorkId:work.id,CategoryId:this.category.val()},a=DataApp.currentUser.url+"/product/create";this.requestHandler(a,{data:JSON.stringify(o)},this.workCreatedComplete)},APP.AddProductScreen.prototype.workCreatedComplete=function(t){this.showFlash("succes","El producto se subió exitosamente"),this.work=t.data.work,this.workForm.hide(),this.sendLoading.hide(),this.send.show();var e=DataApp.currentUser.url+"/work/"+this.work.nameSlugify,i=Utils.addImageFilter(this.work.photo,"w_300,c_limit");this.workView.attr("href",e),this.workNew.attr("href",DataApp.currentUser.url+"/work/add"),this.workEdit.attr("href",e+"/edit"),this.workPhotoPublished.attr("src",i),this.workNamePublished.text(this.work.name),this.workUserPublished.text(DataApp.currentUser.fullname),this.workPublished.show()},APP.AddProductScreen.prototype.categoryHandler=function(t){var e=this.category.find(":selected").data("info"),i=JSON.parse(categories[e-1].data);this.description.val(i.description),this.weight.val(i.weight),this.price.val(i.price);for(line in i.info)this.information.append(i.info[line]+"\n")},APP.AddProductScreen.prototype.priceHandler=function(t){this.finalPrice.val(parseInt(this.price.val())+parseInt(this.profit.val()))},APP.AddProductScreen.prototype.imgComplete=function(t){this.$view.find(".upload").show(),$(".cloudinary-fileupload").show();var e={width:300,crop:"limit"};$.cloudinary.image(t,e).appendTo(this.$view.find(".preview"))};
