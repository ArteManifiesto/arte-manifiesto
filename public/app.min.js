...
var APP=APP||{};APP.UploaderImage=function(e,i,o){this.$view=e,this.photo=null,this.options=o||{uploader:$(".cloudinary-fileupload")},this.uploader=this.options.uploader,this.listeners(),this.onComplete=i},APP.UploaderImage.constructor=APP.UploaderImage,APP.UploaderImage.prototype.listeners=function(){var e=this;this.uploader.cloudinary_fileupload({start:function(i){e.$view.find(".upload").hide(),$(this).hide(),e.$view.find(".preload").removeClass("hide"),e.$view.find(".preload").show()},fail:function(i,o){e.$view.find(".upload").show(),$(this).show(),e.$view.find(".preload").hide()}}).off("cloudinarydone").on("cloudinarydone",function(i,o){if(console.log(o),e.$view.find(".preload").hide(),e.$view.find(".preview").html(""),e.photo=o.result.url,e.onComplete)e.onComplete(o.result);else{var l=Utils.addImageFilter(result.url,"w_200,h_200,c_thumb");this.$view.find(".preview").append($("<img>",{src:l}))}})};
