...
var APP=APP||{};APP.CreatorChapterScreen=function(){APP.BaseScreen.call(this,"creatorChapterScreen"),this.chapter=null},APP.CreatorChapterScreen.constructor=APP.CreatorChapterScreen,APP.CreatorChapterScreen.prototype=Object.create(APP.BaseScreen.prototype),APP.CreatorChapterScreen.prototype.setupUI=function(){this.chapterForm=$(".chapter-form"),this.uploader=$(".uploader-chapter"),this.name=$("input[name=name]"),this.trailer=$("input[name=trailer]"),this.video=$("input[name=video]"),this.releaseDate=$("input[name=releaseDate]"),this.works=$("input[name=works]"),this.description=$("textarea[name=description]"),this.send=$(".send"),this.sendLoading=$(".send-loading"),this.releaseDate.mask("99/99/9999"),this["delete"]=$(".delete-btn"),this.deleteConfirm=$(".delete-confirm"),this.deleteForce=$(".delete-force"),this.cancel=$(".cancel"),this.publishBtn=$(".publish-btn"),edit&&$("input[name=hasContest]").attr("checked",chapter.hasContest),this.uploaderImage=new APP.UploaderImage(this.uploader,this.imgComplete),edit&&(this.uploaderImage.photo=chapter.photo),$("input[type=checkbox]").change(this.checkHasContestHandler),$("input[type=checkbox]").change()},APP.CreatorChapterScreen.prototype.checkHasContestHandler=function(){$(this).parent().find(".value").text(this.checked?"On":"Off")},APP.CreatorChapterScreen.prototype.listeners=function(){APP.BaseScreen.prototype.listeners.call(this),this.chapterForm.submit(this.chapterFormSubmitHandler.bind(this)),this["delete"].click(this.deleteHandler.bind(this)),this.cancel.click(this.cancelHandler.bind(this)),this.deleteForce.click(this.deleteForceHandler.bind(this)),this.publishBtn.click(this.publishHandler.bind(this))},APP.CreatorChapterScreen.prototype.publishHandler=function(){var e="/tv/chapter/"+(chapter.published?"unpublish":"publish");this.requestHandler(e,{idChapter:chapter.id},this.publishComplete)},APP.CreatorChapterScreen.prototype.publishComplete=function(e){chapter=e.data.chapter,chapter.published?this.publishBtn.addClass("publish").text("PUBLICADO"):this.publishBtn.removeClass("publish").text("PUBLICAR")},APP.CreatorChapterScreen.prototype.deleteHandler=function(e){e.preventDefault(),this["delete"].hide(),this.publishBtn.hide(),this.deleteConfirm.show()},APP.CreatorChapterScreen.prototype.cancelHandler=function(e){e.preventDefault(),this["delete"].show(),this.publishBtn.show(),this.deleteConfirm.hide()},APP.CreatorChapterScreen.prototype.deleteForceHandler=function(e){e.preventDefault();var t="/tv/chapter/delete";this.requestHandler(t,{idChapter:chapter.id},this.deleteForceComplete)},APP.CreatorChapterScreen.prototype.deleteForceComplete=function(){this.showFlash("succes","Se elimino el capítulo"),setTimeout(function(){window.location.href="/tv"},1e3)},APP.CreatorChapterScreen.prototype.chapterFormSubmitHandler=function(e){e.preventDefault();var t=[],r=this;if(this.uploaderImage.photo||t.push("Ingrese una foto"),Validations.notBlank(this.name.val())&&t.push("Ingrese un nombre"),Validations.notBlank(this.trailer.val())&&t.push("Ingresa un trailer"),Validations.notBlank(this.video.val())&&t.push("Ingresa un video"),Validations.notBlank(this.releaseDate.val())&&t.push("Ingresa la fecha de emisión"),Validations.notBlank(this.works.val())&&t.push("Ingresa las obras del capítulo"),Validations.notBlank(this.description.val())&&t.push("Ingrese una descripcion"),t.length>0)return this.showFlash("error",t);this.sendLoading.show(),this.send.hide();var a=this.chapterForm.serializeArray();$.each(a,function(e,t){"photo"===t.name&&(t.value=r.uploaderImage.photo),"hasContest"===t.name&&(t.value="on"===t.value)});var i=edit?"/tv/chapter/update":"/tv/chapter/create";this.requestHandler(i,a,this.chapterCreatedComplete)},APP.CreatorChapterScreen.prototype.chapterCreatedComplete=function(e){edit?this.showFlash("succes","Su capítulo se actualizó exitosamente"):this.showFlash("succes","Su capítulo se subió exitosamente"),this.chapter=e.data.chapter,setTimeout(function(){window.location.href="/tv/chapter/"+this.chapter.nameSlugify}.bind(this),1e3)},APP.CreatorChapterScreen.prototype.chapterDeleteForceHandler=function(){var e=DataApp.currentUser.url+"/work/delete";this.requestHandler(e,{idWork:this.work.id},this.forceComplete)},APP.CreatorChapterScreen.prototype.forceComplete=function(){this.showFlash("succes","Se elimino tu obra"),setTimeout(function(){window.location.href=DataApp.currentUser.url},1e3)},APP.CreatorChapterScreen.prototype.deleteCancel=function(e){this.chapterDelete.show(),this.chapterDeleteConfirm.hide()},APP.CreatorChapterScreen.prototype.imgComplete=function(e){this.$view.find(".upload").show(),$(".cloudinary-fileupload").show();var t={width:300,crop:"limit"};$.cloudinary.image(e,t).appendTo(this.$view.find(".preview"))};
