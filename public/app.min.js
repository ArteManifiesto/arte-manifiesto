...
var APP=APP||{};APP.BaseNavigation=function(){this.currentPage=0,this.totalPages=null,this.currentPageData,this.listeners(),this.needChangeUrl=!1,this.ajax=null},APP.BaseNavigation.constructor=APP.BaseNavigation,APP.BaseNavigation.prototype=Object.create(EventDispatcher.prototype),APP.BaseNavigation.prototype.start=function(){},APP.BaseNavigation.prototype.listeners=function(){},APP.BaseNavigation.prototype.suspend=function(){},APP.BaseNavigation.prototype.restart=function(){},APP.BaseNavigation.prototype.gotoPage=function(t,a){var e=t||this.currentPage+1;if(!a){if(this.currentPage===e)return;0===this.currentPage&&(this.currentPage=1)}this.totalPages&&e>this.totalPages||(this.dispatchEvent({type:Events.LOAD_START}),this.newPageUrl(e),this.ajax=Utils.getData({url:DataApp.currentUrl}).done(this.afterGetData.bind(this)))},APP.BaseNavigation.prototype.afterGetData=function(t){console.log(t),this.currentPage=t.pagination.page,this.totalPages=t.pagination.pages,this.currentPageData=t,this.dispatchEvent({type:Events.LOAD_END,data:t})},APP.BaseNavigation.prototype.newPageUrl=function(t){DataApp.currentUrl=DataApp.currentUrl.replace(/\/$/g,""),DataApp.currentUrl.indexOf("/page-")===-1&&(DataApp.currentUrl+="/page-"+this.currentPage),DataApp.currentUrl=DataApp.currentUrl.replace("page-"+this.currentPage,"page-"+t)},APP.BaseNavigation.prototype.reset=function(){this.ajax&&this.ajax.abort(),this.currentPageData=null,this.gotoPage(1,!0),Utils.changeUrl("",DataApp.currentUrl)};
...
var APP=APP||{},scope,timeout;APP.CreatorChapterScreen=function(){APP.BaseScreen.call(this,"creatorPost"),scope=this},APP.CreatorChapterScreen.constructor=APP.CreatorChapterScreen,APP.CreatorChapterScreen.prototype=Object.create(APP.BaseScreen.prototype),APP.CreatorChapterScreen.prototype.setupUI=function(){this.name=$("input[name=name]"),this.video=$("input[name=video]"),this.releaseDate=$("input[name=releaseDate]"),this.description=$("textarea[name=description]"),this.status=$(".status"),this["delete"]=$(".delete-btn"),this.deleteConfirm=$(".delete-confirm"),this.deleteForce=$(".delete-force"),this.cancel=$(".cancel"),this.previewBtn=$(".preview-btn"),this.publishBtn=$(".publish-btn"),this.thumbnail=new APP.UploaderImage($(".thumbnail-uploader"),this.coverComplete,{uploader:$(".editor-cover")}),edit&&(this.category.find("option[value="+post.Category.id+"]").attr("selected",!0),this.cover.photo=post.photo),this.editable=$(".editable"),this.editor=new MediumEditor(".editable",{buttonLabels:"fontawesome",targetBlank:!0,imageDragging:!1,placeholder:{text:"Ingresa el contenido del post :)"},toolbar:{buttons:["h2","h3","bold","italic","quote","anchor","justifyLeft","justifyCenter","justifyRight"]}}),this.editable.mediumInsert({editor:this.editor,addons:{embeds:{placeholder:"Inserta el código de embebido de youtube y luego presiona enter"}}}),this.isUploading=!1},APP.CreatorChapterScreen.prototype.listeners=function(){APP.BaseScreen.prototype.listeners.call(this),Broadcaster.addEventListener("imageStarted",this.imageStarted.bind(this)),Broadcaster.addEventListener("imageProgressComplete",this.progressComplete.bind(this)),Broadcaster.addEventListener("imageLoaded",this.imageLoaded.bind(this));var e=MediumEditor.util.throttle(this.autoSave.bind(this),2e3);this.editor.subscribe("editableInput",e),window.onbeforeunload=this.beforeUnLoad.bind(this),this.category.change(this.inputChange.bind(this)),this.name.keyup(this.nameKeyUp.bind(this)),this["delete"].click(this.deleteHandler.bind(this)),this.cancel.click(this.cancelHandler.bind(this)),this.deleteForce.click(this.deleteForceHandler.bind(this)),this.publishBtn.click(this.publishHandler.bind(this)),this.amBtn.click(this.featuredHandler.bind(this))},APP.CreatorChapterScreen.prototype.publishHandler=function(){if(!post)return this.showFlash("error",["Rellena todos los campos del post"]);var e="/blog/post/"+(post.published?"unpublish":"publish");this.requestHandler(e,{idPost:post.id},this.publishComplete)},APP.CreatorChapterScreen.prototype.publishComplete=function(e){post=e.data.post,post.published?this.publishBtn.addClass("publish").text("PUBLICADO"):this.publishBtn.removeClass("publish").text("PUBLICAR")},APP.CreatorChapterScreen.prototype.featuredHandler=function(){if(!post)return this.showFlash("error",["Rellena todos los campos del post"]);var e="/blog/post/"+(post.featured?"unfeatured":"featured");this.requestHandler(e,{idPost:post.id},this.featuredComplete)},APP.CreatorChapterScreen.prototype.featuredComplete=function(e){post=e.data.post,post.featured?this.amBtn.addClass("am"):this.amBtn.removeClass("am")},APP.CreatorChapterScreen.prototype.imageStarted=function(){this.isUploading=!0,this.status.text("Cargando imagenes....")},APP.CreatorChapterScreen.prototype.progressComplete=function(){this.status.text("Procesando imagenes....")},APP.CreatorChapterScreen.prototype.imageLoaded=function(){this.isUploading=!1,this.autoSave(null,this.editable),this.status.text("Imagenes cargadas")},APP.CreatorChapterScreen.prototype.autoSave=function(e,t){if(this.isUploading)return this.showFlash("error",["Las imágenes aún se estan cargando"]);var o=[],i=this.name.val(),r=this.category.val();if(this.editable=t,i.trim().length<1&&o.push("Agrega un titulo"),null===r&&o.push("Selecciona una categoria"),null===this.cover.photo&&o.push("Selecciona una imagen de cover"),o.length>0)return this.showFlash("error",o);var s=this.editor.serialize()["element-0"].value;t=$(t);var a={body:s,name:i,category:r,description:t.find("p").text().substr(0,180),photo:this.cover.photo};this.status.text("Guardando.....");var n;post?(n="/blog/post/update",a.idPost=post.id):n="/blog/post/create",this.requestHandler(n,a,this.saveRequestComplete)},APP.CreatorChapterScreen.prototype.saveRequestComplete=function(e){post=e.data.post;var t="/blog/post/"+post.nameSlugify;edit&&Utils.changeUrl(post.name,t+"/edit"),this.previewBtn.attr("href",t),this.status.text("✓ guardado")},APP.CreatorChapterScreen.prototype.beforeUnLoad=function(e){if(this.isUploading){var t="Aun no se han guardado tus cambios!";return"undefined"==typeof e&&(e=window.event),e&&(e.returnValue=t),t}},APP.CreatorChapterScreen.prototype.thumbnailComplete=function(e){this.$view.find(".upload").show(),$(".cloudinary-fileupload").show();var t={width:300,crop:"limit"};$.cloudinary.image(e,t).appendTo(this.$view.find(".preview"))},APP.CreatorChapterScreen.prototype.inputChange=function(){this.autoSave(null,this.editable)},APP.CreatorChapterScreen.prototype.nameKeyUp=function(){clearTimeout(timeout),timeout=setTimeout(function(){scope.autoSave(null,scope.editable)},1e3)},APP.CreatorChapterScreen.prototype.deleteHandler=function(e){e.preventDefault(),this["delete"].hide(),this.previewBtn.hide(),this.publishBtn.hide(),this.amBtn.hide(),this.deleteConfirm.show()},APP.CreatorChapterScreen.prototype.cancelHandler=function(e){e.preventDefault(),this["delete"].show(),this.previewBtn.show(),this.publishBtn.show(),this.amBtn.show(),this.deleteConfirm.hide()},APP.CreatorChapterScreen.prototype.deleteForceHandler=function(e){e.preventDefault();var t="/blog/post/delete";this.requestHandler(t,{idPost:post.id},this.deleteForceComplete)},APP.CreatorChapterScreen.prototype.deleteForceComplete=function(){this.showFlash("succes","Se elimino tu post"),setTimeout(function(){window.location.href="/blog"},1e3)};
